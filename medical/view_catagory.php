                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                          <?php
                          $sn=1;
                           $td=mysqli_query($con,"SELECT * FROM catagory_name WHERE user_id='".$_SESSION['muser']."'");
                          while($row=mysqli_fetch_row($td))
                      {
                          echo'<tr>
                            ...
                            <td>'.$sn.'</td>
                            <td>'.$row[1].'</td>
                             <td><a href="update_catagory.php?id='.$row[0].'"><button type="button " class="btn btn-social-icon  btn-primary"><i class="mdi mdi-lead-pencil"></i></button></a></td>

                              <td><a href="delete_catagory.php?id='.$row[0].'"><button type="button " class="btn btn-social-icon  btn-danger"><i class="mdi mdi-window-close"></i></button></a></td>
