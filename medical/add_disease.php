              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card" style="border-top: 4px solid blue;border-radius: 10px;">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="add_disease.php" method="POST">
...
{
  $NAME=$_POST['cname'];
if(mysqli_query($con,"INSERT INTO disease_name VALUES('','".$NAME."','".$_SESSION['muser']."')"))
  {

    echo "
    <script>
    alert('Disease Added');
    window.location.href='add_disease.php';
    </script>
    ";
    }
  else
