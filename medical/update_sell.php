...
?>
  ...
  <body>
    <?php 
      ...
      $cname2=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM  sell_details WHERE ID='".$_GET['id']."'"));
   ?>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card" style="border-top: 4px solid red;border-radius: 10px;">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="update_sell.php" method="POST">
...
if(isset($_POST['csave']))
{
  $cname=$_POST['cname'];
  $id=$_POST['id9'];
if(mysqli_query($con,"UPDATE sell_details SET NAME='".$cname."'WHERE ID='".$id."'"))
  {
