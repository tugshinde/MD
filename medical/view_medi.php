            ...
            <br>
             <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">MEDI INFO</h4>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        <thead>
                          <tr style="background-color:#8f5fe8;color: #fff;">
                            ...
                            <th style="color:#fff">MEDI NAME</th>
                      ...
                      {
                        $cname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM brand_name WHERE ID='".$row[1]."'"));

                        $catname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM catagory_name WHERE ID='".$row[2]."'"));

                        $dname=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM disease_name WHERE ID='".$row[3]."'"));
                          ...
                          echo'<tr>
                            ...
                            <td>'.$row[4].'</td>
                              ...
                              <td><a href="delete_info.php?id='.$row[0].'"><button type="button " class="btn btn-social-icon  btn-danger"><i class="mdi mdi-window-close"></i></button></a></td>
