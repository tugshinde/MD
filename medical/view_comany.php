            ...
            <br>
             <div class="row">
              <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">COMPANY/BRAND</h4>
                    <div class="table-responsive">
                          ...
                          while($row=mysqli_fetch_row($td))
                      {
                          echo'<tr>
                            <td>'.$sn.'</td>
                            <td>'.$row[1].'</td>
                             <td><a href="update_company.php?id='.$row[0].'"><button type="button " class="btn btn-social-icon  btn-primary"><i class="mdi mdi-lead-pencil"></i></button></a></td>

                              <td><a href="delete_company.php?id='.$row[0].'"><button type="button " class="btn btn-social-icon  btn-danger"><i class="mdi mdi-window-close"></i></button></a></td>
