...
?>
  ...
  <body>
    <?php 
      ...
      $cname2=mysqli_fetch_row(mysqli_query($con,"SELECT * FROM  disease_name WHERE ID='".$_GET['id']."'"));
   ?>
              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card" style="border-top: 4px solid blue;border-radius: 10px;">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="update_disease.php" method="POST">
                      <div class="form-group">
                        <label for="exampleInputUsername1">DISEASE NAME</label>
                        <input type="text" style="color:orange;font-weight: bold;" name="cname" value="<?php echo $cname2[1]?>">
                      </div>
...
if(isset($_POST['csave']))
{
  $NAME=$_POST['cname'];
   $id=$_POST['id2'];
if(mysqli_query($con,"UPDATE disease_name SET NAME='".$NAME."' WHERE ID='".$id."'"))
  {

    echo "
    <script>
    alert('Disease Updated Successfully..!');
    window.location.href='view_disease.php';
    </script>
    ";
    }
  else
