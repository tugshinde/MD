              ...
              <div class="col-md-6 grid-margin stretch-card">
                <div class="card" style="border-top: 4px solid orange;border-radius: 10px;">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="add_company.php" method="POST">
                      <div class="form-group">
                        <label for="exampleInputUsername1">Company Name</label>
                        <input type="text" style="color:orange;font-weight: bold;" class="form-control" id="exampleInputUsername1" name="cname" required>
                      </div>
...
{
  $NAME=$_POST['cname'];
if(mysqli_query($con,"INSERT INTO brand_name VALUES('','".$NAME."','".$_SESSION['muser']."')"))
  {
